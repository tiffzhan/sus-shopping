  ...
  return (
    <div style={{ padding: "32px 40px", maxWidth: "640px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
          {[
            ...
            <div key={item.key} style={{ display: "grid", gridTemplateColumns: "1fr auto", gap: "12px", padding: "12px", border: "1px solid var(--border)" }}>
              <div>
                <div style={{ fontFamily: "'Poppins', sans-serif", fontSize: "10px", letterSpacing: "0.1em", marginBottom: "3px" }}>{item.label}</div>
      ...
      <Section label="BACKGROUND REFRESH">
        ...
        <div style={{ background: "var(--surface2)", border: "1px solid var(--border)", padding: "16px", fontFamily: "'Poppins', sans-serif", fontSize: "11px", color: "var(--text-muted)", lineHeight: 1.8 }}>
          <div style={{ fontFamily: "'Poppins', sans-serif", fontSize: "9px", letterSpacing: "0.1em", color: "var(--text-dim)", marginBottom: "8px" }}>VERCEL CRON (vercel.json):</div>
          {'{'}<br />
          &nbsp;&nbsp;"crons": [{'{'}<br />
          &nbsp;&nbsp;&nbsp;&nbsp;"path": "/api/refresh",<br />
          &nbsp;&nbsp;&nbsp;&nbsp;"schedule": "0 */6 * * *"<br />
...
function Section({ label, children }: { label: string; children: React.ReactNode }) {
  return (
    <div style={{ marginBottom: "32px" }}>
      <div style={{ fontFamily: "'Poppins', sans-serif", fontSize: "10px", letterSpacing: "0.2em", color: "var(--text-dim)", borderBottom: "1px solid var(--border)", paddingBottom: "8px", marginBottom: "16px" }}>
        {label}
      </div>
      {children}
    </div>
...
function Row({ label, children }: { label: string; children: React.ReactNode }) {
  return (
    <div style={{ display: "grid", gridTemplateColumns: "140px 1fr", gap: "12px", padding: "10px 0", borderBottom: "1px solid var(--border)" }}>
      <div style={{ fontFamily: "'Poppins', sans-serif", fontSize: "9px", letterSpacing: "0.1em", color: "var(--text-muted)", paddingTop: "2px" }}>
        {label}
      </div>
